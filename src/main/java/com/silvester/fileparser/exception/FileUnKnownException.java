 ...
 * @author lvpanfeng
 * @version 1.0
 * @since 2018-08-24 16:02
 */

public class FileUnKnownException extends FileParserException{
    ...
    protected FileUnKnownException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
